...
public class DocuportConstants {
    ...
    public static final String USERNAME_SUPERVISOR = "b1g2_client@gmail.com";
    public static final String USERNAME_EMPLOYEE = "b1g2_client@gmail.com";
    ...
    public static final String RESET_PASSWORD_CONFIRMATION_MESSAGE = "We've sent you an email with a link to reset your password. Please check your email.";
